...
insert into bankaccount values('Swatika',54657896);
...
EXECUTE InsertBankData('Riya', 78967243);
...
EXECUTE UpdateBankData('Meera', 773453654);

SELECT * FROM bankaccount;

SELECT * FROM bankaccount where customerName='Meera';
